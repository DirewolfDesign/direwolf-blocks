...
/**
 * DirewolfBlocks_Controls class. Class to work with DirewolfBlocks Controls.
 */
class DirewolfBlocks_Controls {
    /**
     * DirewolfBlocks_Controls constructor.
     */
    ...
    public function get_controls() {
        return apply_filters( 'dwb/controls/all', array() );
    }
    ...
    public function get_controls_categories() {
        return apply_filters(
            'dwb/controls/categories',
            array(
                'basic'    => __( 'Basic', 'dwb' ),
                'content'  => __( 'Content', 'dwb' ),
                'choice'   => __( 'Choice', 'dwb' ),
                'advanced' => __( 'Advanced', 'dwb' ),
                'layout'   => __( 'Layout', 'dwb' ),
            )
        );
    }
