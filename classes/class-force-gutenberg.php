<?php
/**
 * DirewolfBlocks force enable gutenberg on constructor page.
 *
...
/**
 * DirewolfBlocks_Force_Gutenberg class. Class to work with DirewolfBlocks CPT.
 */
class DirewolfBlocks_Force_Gutenberg {
    /**
     * DirewolfBlocks_Force_Gutenberg constructor.
     */
    ...
    /**
     * Force set Gutenberg editor for 'direwolfblocks' in 3rd-party plugins/themes, that uses their own builders.
     *
     * @param boolean $use_block_editor Use block editor.
     * @param object  $post The post object.
     */
    public function classic_plugin_force_gutenberg_3( $use_block_editor, $post ) {
        if ( isset( $post->post_type ) && 'direwolfblocks' === $post->post_type ) {
            return true;
        }
    ...
    /**
     * Force enable Gutenberg in 'direwolfblocks' for users with disabled option "Visual Editor".
     *
    ...
    public function user_can_richedit_force( $enabled ) {
        ...
        if ( isset( $post_type ) && 'direwolfblocks' !== $post_type ) {
            return $enabled;
        }
...
new DirewolfBlocks_Force_Gutenberg();
